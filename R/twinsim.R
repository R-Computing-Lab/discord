...
kinsim <- function(nMZ=100,nDZ=nMZ,b1=c(),b2=c(),mu=0,acde=c(1,0,0,0),randomslope=NULL,threshold=0,cens=FALSE,wide=TRUE,...) {
  require(mets)
  n <- nMZ+nDZ
...
cor(data$y1[data$zyg=='MZ'],data$y2[data$zyg=='MZ']);cor(data$y1[data$zyg=='DZ'],data$y2[data$zyg=='DZ'])