...
test_that("restructure returns a data frame. the number of columns depends on the function argument. ", {
   ...
   expect_true(ncol(results11)==11+2+2+2) # two for mean/difference score of continuous var1, two for two/thhree grouping variables for categorical var1, and two for mean/difference score of the DV
