---
title: "Categorical predictors demonstartion "
author: Yoo Ri Hwang, Jonathan Trattner, & S. Mason Garrison
...
This vignette aims to introduce the ways to address categorical predictors in the discordant-kinship regressions with the 'discord' package. 

For the general demonstration of discordant-kinship regression with the 'discord' package, please refer to Regression demonstration vignette in this package. 

The data, the research question, the much of the codes are from the [regression demonstration vignette](https://github.com/R-Computing-Lab/discord/blob/main/vignettes/regression.Rmd).

It is highly recommended to read the [regression demonstration vignette](https://github.com/R-Computing-Lab/discord/blob/main/vignettes/regression.Rmd) before reading this vignette to get informed of basic logic of the discordant-kinship regressions, data information, and codes.
