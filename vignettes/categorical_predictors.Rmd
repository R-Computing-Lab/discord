...
In kinship regression, a variable can be at the within dyad level, the between-dyad level, or a combination. This combination is called a "mixed variable", meaning that it varies both within and between dyads. Gender is a prototypical example of a mixed variable <confirm>. To prepare the data for analysis, we use the discord_data() function.
