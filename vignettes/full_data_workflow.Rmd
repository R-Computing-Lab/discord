...
This vignette presents a fully worked example of a discordant-kinship regression using the {discord} package. It walks through data cleaning, restructuring, and analysis. The example uses synthetic data to illustrate potential data structures and analysis steps. However, the principles and methods can be applied to real-world datasets with similar characteristics.
